...
func TestInstallAndUninstallDBDrivers(t *testing.T) {
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&postgres.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/postgres"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&postgres.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/postgres"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&mysql.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/mysql"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&mysql.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/mysql"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&sqlserver.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/sqlserver"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&sqlserver.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/sqlserver"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&sqlite.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/sqlite"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&sqlite.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/sqlite"))
...
func TestInstallAndUninstallFilesystemDrivers(t *testing.T) {
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&s3.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/s3"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&s3.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/s3"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&cos.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/cos"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&cos.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/cos"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&oss.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/oss"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&oss.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/oss"))
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&minio.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/minio"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&minio.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/minio"))
...
func TestInstallAndUninstallCacheDrivers(t *testing.T) {
	...
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "&redis.ServiceProvider{},"))
	assert.False(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/redis"))
	...
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "&redis.ServiceProvider{},"))
	assert.True(t, file.Contain(path.Bootstrap("providers.go"), "github.com/goravel/redis"))
